...
class FoodTest {
    ...
    void testFoodRecord() {
        ...
        Assertions.assertEquals(MeasurementType.GRAM, food.measurementType());
        Assertions.assertEquals(100.0, food.unitsPerServing());
        Assertions.assertEquals(2, food.servingsPerContainer());
        Assertions.assertEquals(300.0, food.calories());
        Assertions.assertEquals(30.0, food.carbs());
        Assertions.assertEquals(10.0, food.fat());
        Assertions.assertEquals(15.0, food.protein());
    }
    ...
    void testToString() {
        ...
        Assertions.assertTrue(s.contains("100.0 g"));
